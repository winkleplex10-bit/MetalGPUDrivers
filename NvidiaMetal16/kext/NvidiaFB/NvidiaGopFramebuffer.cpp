...
#define NVFB_LOG(fmt, ...) \
    IOLog("NvidiaMetal16: " fmt "\n", ##__VA_ARGS__)

OSDefineMetaClassAndStructors(NvidiaGopFramebuffer16, IOFramebuffer);
...
bool NvidiaGopFramebuffer16::parseBootVideo()
{
...
bool NvidiaGopFramebuffer16::gopLivesInThisDevice()
{
...
void NvidiaGopFramebuffer16::publishIdentity()
{
    if (fPCI == nullptr) {
        return;
    }
    ...
    fPCI->setProperty("NVDAType", "NvidiaMetal16");
...
void NvidiaGopFramebuffer16::fillPixelInfo(IOPixelInformation *pixelInfo) const
{
...
bool NvidiaGopFramebuffer16::start(IOService *provider)
{
...
void NvidiaGopFramebuffer16::stop(IOService *provider)
{
    fPCI = nullptr;
    fHaveGop = false;
    fIsConsole = false;
...
void NvidiaGopFramebuffer16::free()
{
    super::free();
}

IOReturn NvidiaGopFramebuffer16::enableController()
{
    if (!fHaveGop) {
...
bool NvidiaGopFramebuffer16::isConsoleDevice()
{
    return fIsConsole;
}

IODeviceMemory *NvidiaGopFramebuffer16::getApertureRange(IOPixelAperture aperture)
{
...
IODeviceMemory *NvidiaGopFramebuffer16::getVRAMRange()
{
...
const char *NvidiaGopFramebuffer16::getPixelFormats()
{
    return (fDepth == 16) ? IO16BitDirectPixels : IO32BitDirectPixels;
}

IOItemCount NvidiaGopFramebuffer16::getDisplayModeCount()
{
    return fHaveGop ? 1 : 0;
}

IOReturn NvidiaGopFramebuffer16::getDisplayModes(IODisplayModeID *allDisplayModes)
{
...
IOReturn NvidiaGopFramebuffer16::getInformationForDisplayMode(
...
UInt64 NvidiaGopFramebuffer16::getPixelFormatsForDisplayMode(
...
IOReturn NvidiaGopFramebuffer16::getPixelInformation(
    IODisplayModeID displayMode, IOIndex depth,
...
IOReturn NvidiaGopFramebuffer16::getCurrentDisplayMode(IODisplayModeID *displayMode,
                                                    IOIndex *depth)
{
...
IOReturn NvidiaGopFramebuffer16::setDisplayMode(IODisplayModeID displayMode,
                                             IOIndex depth)
{
...
IOReturn NvidiaGopFramebuffer16::getStartupDisplayMode(IODisplayModeID *displayMode,
                                                    IOIndex *depth)
{
    return getCurrentDisplayMode(displayMode, depth);
}

IOReturn NvidiaGopFramebuffer16::getTimingInfoForDisplayMode(
...
IOItemCount NvidiaGopFramebuffer16::getConnectionCount()
{
    return 1;
}

IOReturn NvidiaGopFramebuffer16::getAttribute(IOSelect attribute, uintptr_t *value)
{
...
IOReturn NvidiaGopFramebuffer16::setAttribute(IOSelect attribute, uintptr_t value)
{
...
IOReturn NvidiaGopFramebuffer16::getAttributeForConnection(
...
IOReturn NvidiaGopFramebuffer16::connectFlags(IOIndex connectIndex,

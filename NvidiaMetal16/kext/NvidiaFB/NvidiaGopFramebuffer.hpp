...
#ifndef NV_METAL16_GOP_FRAMEBUFFER_HPP
#define NV_METAL16_GOP_FRAMEBUFFER_HPP
...
class NvidiaGopFramebuffer16 : public IOFramebuffer
{
    OSDeclareDefaultStructors(NvidiaGopFramebuffer16);

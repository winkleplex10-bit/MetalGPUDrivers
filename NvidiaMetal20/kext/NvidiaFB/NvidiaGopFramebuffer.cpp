...
#define NVFB_LOG(fmt, ...) \
    IOLog("NvidiaMetal20: " fmt "\n", ##__VA_ARGS__)

OSDefineMetaClassAndStructors(NvidiaGopFramebuffer20, IOFramebuffer);
...
bool NvidiaGopFramebuffer20::parseBootVideo()
{
...
bool NvidiaGopFramebuffer20::gopLivesInThisDevice()
{
...
void NvidiaGopFramebuffer20::publishIdentity()
{
    if (fPCI == nullptr) {
        return;
    }
    ...
    fPCI->setProperty("NVDAType", "NvidiaMetal20");
...
void NvidiaGopFramebuffer20::fillPixelInfo(IOPixelInformation *pixelInfo) const
{
...
bool NvidiaGopFramebuffer20::start(IOService *provider)
{
...
void NvidiaGopFramebuffer20::stop(IOService *provider)
{
    fPCI = nullptr;
    fHaveGop = false;
    fIsConsole = false;
...
void NvidiaGopFramebuffer20::free()
{
    super::free();
}

IOReturn NvidiaGopFramebuffer20::enableController()
{
    if (!fHaveGop) {
...
bool NvidiaGopFramebuffer20::isConsoleDevice()
{
    return fIsConsole;
}

IODeviceMemory *NvidiaGopFramebuffer20::getApertureRange(IOPixelAperture aperture)
{
...
IODeviceMemory *NvidiaGopFramebuffer20::getVRAMRange()
{
...
const char *NvidiaGopFramebuffer20::getPixelFormats()
{
    return (fDepth == 16) ? IO16BitDirectPixels : IO32BitDirectPixels;
}

IOItemCount NvidiaGopFramebuffer20::getDisplayModeCount()
{
    return fHaveGop ? 1 : 0;
}

IOReturn NvidiaGopFramebuffer20::getDisplayModes(IODisplayModeID *allDisplayModes)
{
...
IOReturn NvidiaGopFramebuffer20::getInformationForDisplayMode(
...
UInt64 NvidiaGopFramebuffer20::getPixelFormatsForDisplayMode(
...
IOReturn NvidiaGopFramebuffer20::getPixelInformation(
    IODisplayModeID displayMode, IOIndex depth,
...
IOReturn NvidiaGopFramebuffer20::getCurrentDisplayMode(IODisplayModeID *displayMode,
                                                    IOIndex *depth)
{
...
IOReturn NvidiaGopFramebuffer20::setDisplayMode(IODisplayModeID displayMode,
                                             IOIndex depth)
{
...
IOReturn NvidiaGopFramebuffer20::getStartupDisplayMode(IODisplayModeID *displayMode,
                                                    IOIndex *depth)
{
    return getCurrentDisplayMode(displayMode, depth);
}

IOReturn NvidiaGopFramebuffer20::getTimingInfoForDisplayMode(
...
IOItemCount NvidiaGopFramebuffer20::getConnectionCount()
{
    return 1;
}

IOReturn NvidiaGopFramebuffer20::getAttribute(IOSelect attribute, uintptr_t *value)
{
...
IOReturn NvidiaGopFramebuffer20::setAttribute(IOSelect attribute, uintptr_t value)
{
...
IOReturn NvidiaGopFramebuffer20::getAttributeForConnection(
...
IOReturn NvidiaGopFramebuffer20::connectFlags(IOIndex connectIndex,

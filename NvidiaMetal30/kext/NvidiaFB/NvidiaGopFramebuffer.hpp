...
#ifndef NV_METAL30_GOP_FRAMEBUFFER_HPP
#define NV_METAL30_GOP_FRAMEBUFFER_HPP
...
class NvidiaGopFramebuffer30 : public IOFramebuffer
{
    OSDeclareDefaultStructors(NvidiaGopFramebuffer30);

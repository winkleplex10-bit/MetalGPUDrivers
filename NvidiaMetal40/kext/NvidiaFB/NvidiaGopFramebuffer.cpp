...
#define NVFB_LOG(fmt, ...) \
    IOLog("NvidiaMetal40: " fmt "\n", ##__VA_ARGS__)

OSDefineMetaClassAndStructors(NvidiaGopFramebuffer40, IOFramebuffer);
...
bool NvidiaGopFramebuffer40::parseBootVideo()
{
...
bool NvidiaGopFramebuffer40::gopLivesInThisDevice()
{
...
void NvidiaGopFramebuffer40::publishIdentity()
{
    if (fPCI == nullptr) {
        return;
    }
    ...
    fPCI->setProperty("NVDAType", "NvidiaMetal40");
...
void NvidiaGopFramebuffer40::fillPixelInfo(IOPixelInformation *pixelInfo) const
{
...
bool NvidiaGopFramebuffer40::start(IOService *provider)
{
...
void NvidiaGopFramebuffer40::stop(IOService *provider)
{
    fPCI = nullptr;
    fHaveGop = false;
    fIsConsole = false;
...
void NvidiaGopFramebuffer40::free()
{
    super::free();
}

IOReturn NvidiaGopFramebuffer40::enableController()
{
    if (!fHaveGop) {
...
bool NvidiaGopFramebuffer40::isConsoleDevice()
{
    return fIsConsole;
}

IODeviceMemory *NvidiaGopFramebuffer40::getApertureRange(IOPixelAperture aperture)
{
...
IODeviceMemory *NvidiaGopFramebuffer40::getVRAMRange()
{
...
const char *NvidiaGopFramebuffer40::getPixelFormats()
{
    return (fDepth == 16) ? IO16BitDirectPixels : IO32BitDirectPixels;
}

IOItemCount NvidiaGopFramebuffer40::getDisplayModeCount()
{
    return fHaveGop ? 1 : 0;
}

IOReturn NvidiaGopFramebuffer40::getDisplayModes(IODisplayModeID *allDisplayModes)
{
...
IOReturn NvidiaGopFramebuffer40::getInformationForDisplayMode(
...
UInt64 NvidiaGopFramebuffer40::getPixelFormatsForDisplayMode(
...
IOReturn NvidiaGopFramebuffer40::getPixelInformation(
    IODisplayModeID displayMode, IOIndex depth,
...
IOReturn NvidiaGopFramebuffer40::getCurrentDisplayMode(IODisplayModeID *displayMode,
                                                    IOIndex *depth)
{
...
IOReturn NvidiaGopFramebuffer40::setDisplayMode(IODisplayModeID displayMode,
                                             IOIndex depth)
{
...
IOReturn NvidiaGopFramebuffer40::getStartupDisplayMode(IODisplayModeID *displayMode,
                                                    IOIndex *depth)
{
    return getCurrentDisplayMode(displayMode, depth);
}

IOReturn NvidiaGopFramebuffer40::getTimingInfoForDisplayMode(
...
IOItemCount NvidiaGopFramebuffer40::getConnectionCount()
{
    return 1;
}

IOReturn NvidiaGopFramebuffer40::getAttribute(IOSelect attribute, uintptr_t *value)
{
...
IOReturn NvidiaGopFramebuffer40::setAttribute(IOSelect attribute, uintptr_t value)
{
...
IOReturn NvidiaGopFramebuffer40::getAttributeForConnection(
...
IOReturn NvidiaGopFramebuffer40::connectFlags(IOIndex connectIndex,

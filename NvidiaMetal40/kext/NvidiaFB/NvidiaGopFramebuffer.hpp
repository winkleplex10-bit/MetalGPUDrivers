...
#ifndef NV_METAL40_GOP_FRAMEBUFFER_HPP
#define NV_METAL40_GOP_FRAMEBUFFER_HPP
...
class NvidiaGopFramebuffer40 : public IOFramebuffer
{
    OSDeclareDefaultStructors(NvidiaGopFramebuffer40);

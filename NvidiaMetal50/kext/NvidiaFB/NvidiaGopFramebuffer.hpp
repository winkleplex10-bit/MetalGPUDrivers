...
#ifndef NV_METAL50_GOP_FRAMEBUFFER_HPP
#define NV_METAL50_GOP_FRAMEBUFFER_HPP
...
class NvidiaGopFramebuffer : public IOFramebuffer
{
    OSDeclareDefaultStructors(NvidiaGopFramebuffer);

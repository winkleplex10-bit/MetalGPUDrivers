...
- **Not:** installing WhateverGreen, requiring WEG, requiring `-wegnoegpu`, or requiring WEG removal (NootedRed’s install model)
...
**Method (do not copy):** Lilu-style patching of Apple AMD kexts, DID spoof onto `AMDRadeonX6000*`, WhateverGreen-class blob enablement, or NootedRed’s “remove WEG / disable dGPU” install rules. This repo’s product path is a **new IHV backend** behind `host/` that runs on **macOS 26 without WEG** and owns Raphael by DID.

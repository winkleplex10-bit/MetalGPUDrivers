# coexistence.md — discrete GPU (WEG optional)

**Product policy:** this IHV must **not require** WhateverGreen, Lilu, `-wegnoegpu`, or a disabled dGPU. Narrow DID match only. If WEG is present on another install, do not conflict with it and do not patch it.

**Current lab (2026-09-10):** **macOS 26 Tahoe, no WhateverGreen.** Sequoia WEG measurements below are historical.
